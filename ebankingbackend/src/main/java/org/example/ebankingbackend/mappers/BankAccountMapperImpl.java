...
public class BankAccountMapperImpl {
    ...
    public SavingBankAccountDTO toSavingAccountDTO(SavingAccount savingAccount){
    ...
    public CurrentBankAccountDTO toCurrentAccountDTO(CurrentAccount currentAccount){
